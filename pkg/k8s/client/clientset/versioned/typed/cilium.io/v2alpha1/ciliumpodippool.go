...
type CiliumPodIPPoolInterface interface {
	...
	UpdateStatus(ctx context.Context, ciliumPodIPPool *v2alpha1.CiliumPodIPPool, opts v1.UpdateOptions) (*v2alpha1.CiliumPodIPPool, error)
...
func (c *ciliumPodIPPools) UpdateStatus(ctx context.Context, ciliumPodIPPool *v2alpha1.CiliumPodIPPool, opts v1.UpdateOptions) (result *v2alpha1.CiliumPodIPPool, err error) {
	result = &v2alpha1.CiliumPodIPPool{}
	err = c.client.Put().
		Resource("ciliumpodippools").
		Name(ciliumPodIPPool.Name).
